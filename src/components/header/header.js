...
function Header({error,speed,time,changeText}) {
    return (
        <header>
            <div className="header__container">
                <div className='header__menu menu'>
                    <div className='element' onClick={()=>changeText(ENG_LITERATURE)}>Literature text</div>
                    <div className='element' onClick={()=>changeText(ENG_RANDOM)}>Random text</div>
                    <div className='element' onClick={()=>changeText(ENG_DOCUMENTATION)}>Documentation text</div>
                </div>
